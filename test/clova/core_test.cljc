...
(def only-clova-meta #(select-keys % [:clova.core/type :default-message]))
(def only-clova-set-meta #(select-keys % [:clova.core/type :clova.core/target :default-message :clova.core/args]))
(def exp-email-meta {:clova.core/type :email :clova.core/target :email :default-message "%s should be a valid email address."})
(def exp-post-meta {:clova.core/type :post-code :clova.core/target :post-code :default-message "%s should be a valid post code."})
(def exp-url-meta {:clova.core/type :url :clova.core/target :url :default-message "%s should be a valid url."})
(def exp-greater-meta {:clova.core/type :greater :clova.core/target :count :default-message "%s is %s but it must be greater than %s."})
(def exp-lesser-meta {:clova.core/type :lesser  :clova.core/target :count2 :default-message "%s is %s but it must be less than %s."})
(def exp-between-meta {:clova.core/type :between :clova.core/args [1 9] :clova.core/target :age :default-message "%s is %s but it must be between %s and %s."})
(def exp-matches-meta {:clova.core/type :matches :clova.core/target :matches :default-message "%s is invalid value %s."})
(def exp-zip-meta {:clova.core/type :zip-code :clova.core/target :zip-code :default-message "%s should be a valid zip code."})
(def exp-one-of-meta {:clova.core/type :one-of :clova.core/target :one-of :default-message "%s is %s but should be one of %s."})
(def exp-not-nil-meta {:clova.core/type :not-nil :clova.core/target :not-nil :default-message "%s is required."})
(def exp-required-meta {:clova.core/type :required :clova.core/target :required :default-message "%s is required."})
(def exp-positive-meta {:clova.core/type :positive :clova.core/target :positive :default-message "%s is %s but it should be a positive number."})
(def exp-negative-meta {:clova.core/type :negative :clova.core/target :negative :default-message "%s is %s but it should be a negative number."})
(def exp-length-meta {:clova.core/type :length :clova.core/target :length :default-message "%s is %s but it should have a length of %s."})
(def exp-longer-meta {:clova.core/type :longer :clova.core/target :longer :default-message "%s is %s but it should have a length longer than %s."})
(def exp-shorter-meta {:clova.core/type :shorter :clova.core/target :shorter :default-message "%s is %s but it should have a length shorter than %s."})
(def exp-all-meta {:clova.core/type :all :clova.core/target :all :default-message "%s is %s but it does not meet all of the requirements."})
